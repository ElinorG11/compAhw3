...
struct DataFlowGraph {
    ...
    int _calc_depth(int instruction_ordinal_number) {
		...
		int index = instruction_vertices[instruction_ordinal_number][SRC1].instruction_ordinal_number;
        int dep_a_depth = instruction_vertices[index][DST].depth + instruction_vertices[index][DST].instruction_latency;
		index = instruction_vertices[instruction_ordinal_number][SRC2].instruction_ordinal_number;
        int dep_b_depth = instruction_vertices[index][DST].depth + instruction_vertices[index][DST].instruction_latency;
